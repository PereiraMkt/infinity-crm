      ...
      cards: [
        {
          ...
          priority: "high",
          tags: [
            { label: "CRM", color: "bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-300" }
          ]
        },
        {
          id: "lead-2",
          ...
          priority: "medium",
          tags: [
            { label: "Marketing", color: "bg-purple-100 text-purple-800 dark:bg-purple-900/30 dark:text-purple-300" }
          ]
        }
      ]
    },
      ...
      cards: [
        {
          ...
          priority: "high",
          tags: [
            { label: "Projetos", color: "bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-300" }
          ]
        }
      ]
    },
      ...
      cards: [
        {
          ...
          priority: "medium",
          tags: [
            { label: "Consultoria", color: "bg-yellow-100 text-yellow-800 dark:bg-yellow-900/30 dark:text-yellow-300" }
          ]
        }
      ]
    },
      ...
      cards: [
        {
          ...
          priority: "high",
          tags: [
            { label: "Contrato", color: "bg-orange-100 text-orange-800 dark:bg-orange-900/30 dark:text-orange-300" }
          ]
        }
      ]
    },
      ...
      cards: [
        {
          ...
          priority: "low",
          tags: [
            { label: "Suporte", color: "bg-teal-100 text-teal-800 dark:bg-teal-900/30 dark:text-teal-300" }
          ]
        }
      ]
    }
